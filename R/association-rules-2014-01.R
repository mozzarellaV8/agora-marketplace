...
weedCheck <- subset(fb, fb$subsubcat == "Weed")
write.csv(weedCheck, file = "data/arules/Ag2014-sscWeed.csv", row.names = F)
...
write.csv(synthCheck, file = "data/arules/Ag2014-sscSynth.csv", row.names = F)
...
write.csv(shakeCheck, file = "data/arules/Ag2014-sscShakeTrim.csv", row.names = F)
...
write.csv(seedCheck, file = "data/arules/Ag2014-sscSeeds.csv", row.names = F)
...
write.csv(scripCheck, file = "data/arules/Ag2014-sscPrescription.csv", row.names = F)
...
hashCheck <- subset(fb, fb$subsubcat == "Hash")
write.csv(hashCheck, file = "data/arules/Ag2014-sscHash.csv")
...
edCheck <- subset(fb, fb$subsubcat == "Edibles")
write.csv(edCheck, file = "data/arules/Ag2014-sscEdibles.csv", row.names = F)
...
concentrateCheck <- subset(fb, fb$subsubcat == "Concentrates")
write.csv(concentrateCheck, file = "data/arules/Ag2014-sscConcentrates.csv", row.names = F)
