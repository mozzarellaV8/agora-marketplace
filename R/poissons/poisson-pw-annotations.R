...
postSR2.03p + annotate("text", x = as.Date("2014-09-28"), y = 40379, label = "SR2 complaint filed",
...
preSR2.01p + annotate("text", x = as.Date("2014-09-28"), y = 50000, label = "SR2 complaint filed",
                   family = "Times New Roman", fontface = "italic", size = 4.5, hjust = 1) + 
  annotate("segment", x = as.Date("2014-09-29"), xend = as.Date("2014-10-08"), y = 50000, yend = 50000,
           arrow = arrow(ends = "first", type = "open", angle = 90, length = unit(0.3, "cm"))) +
  annotate("rect", xmin = as.Date("2014-09-29"), xmax = as.Date("2014-10-08"), ymin = 0, ymax = 50000,
